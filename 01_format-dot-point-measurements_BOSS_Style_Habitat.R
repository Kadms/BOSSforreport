...
# Study name ----
study <- "SW_BOSS_Report"  # use this study name to run the example, or change to your own (you will need to save your files with this prefix - see naming of example files)
